...
\! redis-cli < test/redis_utf8

-- ================
-- check all data in UTF8
-- ================
CREATE EXTENSION redis_fdw;
CREATE SERVER redis_testing_server FOREIGN DATA WRAPPER redis_fdw;
CREATE FOREIGN TABLE "Unicode data"(i text, t text)
SERVER redis_testing_server
OPTIONS (database '15');
CREATE USER MAPPING FOR public SERVER redis_testing_server;
SELECT * FROM "Unicode data" ORDER BY i;
DROP FOREIGN TABLE "Unicode data";
DROP SERVER redis_testing_server CASCADE;
